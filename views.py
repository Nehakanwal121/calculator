...
# Initialize gemini
genai.configure(api_key="AIzaSyCDJ6HbOmKkEaZUhPGaKdHFCVlkYzG0y8c")
model = genai.GenerativeModel('models/gemini-2.5-flash')  # Use the correct model from the list
